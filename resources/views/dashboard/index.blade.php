...
<div class="flex h-screen bg-gray-100">
    ...
    <aside class="w-64 bg-white shadow-md">
        ...
        <nav class="mt-4">
            <div id="main-nav">
                <a href="#" class="nav-link block py-2.5 px-6 transition duration-200 nav-link-active" onclick="showContent('dashboard-home', this)">
                    Dashboard
                </a>
...
<script>
    ...
    const subNavContainer = null;
        ...
        const defaultLink = document.querySelector('a[onclick*="dashboard-home"]');
        if (defaultLink) {
            showContent('dashboard-home', defaultLink);
        }
    });
</script>
@endsection
